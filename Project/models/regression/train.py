...
from Project.features.imputation import CAT_UNKNOWN, fit_imputer, apply_imputation
...
def train_model(X, y):
    ...
    return model, mae, rmse,mape,X_val,y_val
...
def train():
    ...
    with mlflow.start_run():
        ...
        X,y=build()
        model, val_mae, val_rmse,val_mape,X_val,y_val= train_model(X, y)
